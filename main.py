...
if authentication_status:
    ...
    if prediction:
        ...
        #ax.fill_between(time,real_h_,1, color="green", alpha=0.2)
        #ax.fill_between(time, real_h_, 0, color='blue', alpha=.1)
        ax.fill_between(time, real_h_, max(real_h_), color='green', alpha=.1)
