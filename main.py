...
if authentication_status:
    ...
    if prediction:
        ...
        ax.set_ylim(min(real_l_)-0.05, max(real_h_)+0.05)
        ...
        ax.fill_between(time,real_l_, color="red", alpha=0.15)
        ax.fill_between(time, real_h_, max(real_h_), color='green', alpha=0.15)
